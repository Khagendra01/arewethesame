CANONICAL_PROMPT_VERSION = "canonical_renderer_v2"
...
- When self/other require different verb agreement, encode it in the same canonical text as [[AGR:self_form|other_form]]. Example: [[SUBJECT]] [[AGR:have|has]] enough evidence.
- Do not place a condition-specific verb form after [[SUBJECT]] when an agreement slot is required.
...
You are a blinded scientific-data auditor. Version X and Version Y should differ only in grammatical ownership of the same history, including any grammar changes mechanically required by that ownership.
