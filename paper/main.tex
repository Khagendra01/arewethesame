...
The v0.7 extension adds a \textbf{FOCAL control}: the historical owner is task-relevant but explicitly not the assistant. Algebraically,
\begin{equation}
\label{eq:decomp}
